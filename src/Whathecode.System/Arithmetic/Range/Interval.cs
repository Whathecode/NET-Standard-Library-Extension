...
namespace Whathecode.System.Arithmetic.Range
{
	...
	/// TODO: The 'ToString' and 'Parse' methods were removed since they relied on TypeConverter, which is not present in the .NET Standard Library. How to support this?
	/// TODO: With new C# 6 features this class can probably be cleaned up a bit. (immutable readonly properties, primary constructor)
	/// </summary>
	/// <remarks>
